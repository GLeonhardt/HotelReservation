        ...
        <div class="card-body">
          <form method="POST" action="/hotels">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="name" name="name" type="text" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" required autocomplete="email" autofocus/>
                @error('name')
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="address" name="address" type="text" value="{{ old('address') }}" class="form-control @error('address') is-invalid @enderror" required autocomplete="address" autofocus/>
                @error('address')
